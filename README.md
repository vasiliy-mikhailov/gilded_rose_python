Код в поддержку постов о снижении time2market за счет применения практик сoding kata <a href="https://habr.com/ru/post/718746/">https://habr.com/ru/post/718746/</a>.
...
Дополнительное пояснение: cотворенными могут быть любые предметы и их качество будет изменяться в соответствии с описанием, но в 2 раза быстрее. Например, cотворенный "Выдержанный бри" будет улучшаться в качестве на 2 единицы вместо одной по мере приближения даты продажи. 
