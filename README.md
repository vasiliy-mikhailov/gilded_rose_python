...
Запишите текущее астрономическое время.
...
После того, как тесты для кода с цикломатической сложностью 5 выполнились без ошибок, запишите:
...
Предупреждение: у вас может не получиться изменить этот код правильно, поскольку он весьма сложный. Код с цикломатической сложностью более 10 трудно поддерживать.
